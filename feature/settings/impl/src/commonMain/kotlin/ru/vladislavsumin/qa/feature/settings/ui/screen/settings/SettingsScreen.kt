...
internal class SettingsScreen(context: ComponentContext) :
    Screen(context),
    TabSupport {

    override val tabState: StateFlow<TabSupport.TabState> = MutableStateFlow(
        TabSupport.TabState(icon = Icons.Default.Settings, name = "Настройки"),
    )

    @Composable
    override fun Render(modifier: Modifier) = SettingsScreenContent(modifier)
}
